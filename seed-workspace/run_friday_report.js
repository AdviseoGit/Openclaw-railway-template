...
async function run() {
    ...
    const tomorrowStr = tomorrow.toISOString().split('T')[0]; // 2026-04-25 (Saturday)
    
    console.log(`Hämtar morgon-data för Fredag (Idag: ${today})...\n`);
    ...
    console.log(`IDAG Fredag (24/4): ${todayP}/510 (${Math.round((todayP/510)*100)}%) - Nya bokningar idag: ${todayNewBookings} st`);
    console.log(`Imorgon Lördag (25/4): ${tomorrowP}/510 (${Math.round((tomorrowP/510)*100)}%) - Nya bokningar idag: ${tomorrowNewBookings} st`);
}
run();
